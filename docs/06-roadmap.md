...
- [ ] TUI: progress view → Browse view (table, bars, breadcrumb, sort, filter, bundles-as-leaves toggle, open in Finder, copy path) → Unaccounted view. — **in progress**, being built concurrently on this branch (`internal/tui`); not yet merged as of this doc update.
